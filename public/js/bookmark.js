...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const featuredSnippet =
    featuredNewsContainer.querySelector(".featured-snippet");
  ...
  function loadAndDisplayBookmarks() {
    ...
    if (bookmarks.length === 0) {
      newsContainer.innerHTML =
        '<p class="empty-bookmark">Anda belum memiliki bookmark. Tambahkan berita ke bookmark untuk melihatnya di sini.</p>';
      return;
    }
  ...
  function displayFeaturedNews(item) {
    ...
    featuredImage.src =
      berita.image.small || "/public/images/skeleton-news.png";
  ...
  function createNewsItem(item) {
    ...
    img.src = berita.image.small || "/public/images/skeleton-news.png";
    img.alt = berita.title;
    img.onerror = function () {
      this.src = "/public/images/skeleton-news.png";
    };
    ...
    newsItemDiv.addEventListener("click", function (e) {
      ...
      document
        ...
        .forEach((el) => el.classList.remove("active-news"));
